# TriAttention：基于三角级数的 KV 缓存压缩实现高效长程推理 交互式教程

基于论文 *TriAttention: Efficient Long Reasoning with Trigonometric KV Compression*，由 **paper-skill** 生成的完整 React + TypeScript + Vite 网页项目。
