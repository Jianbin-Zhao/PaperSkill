      ...
      modules: [
        {
          ...
          id: "2.1",
          title: "扰动一下，输出漂多远",
          desc: "拖动「扰动强度」滑块（0–0.1）：稳定输出在 0.06 之前保持不变，边界脆弱输出从 0.02 起迅速变乱（0.06/0.02 为演示阈值）——漂移大小用归一化编辑距离（NED）量化。",
    ...
    },
    {
      ...
      modules: [
        {
          ...
          desc: "用三种专家共识局面试一遍三分支规则：原标签得到支持就保留、两专家一致就替换、全不一致就送入渲染引导的判定-修正循环——选择「全部不一致」会自动进行 T 轮修正，超过 T 轮仍不一致则转人工预标注。",
      ...
      takeaways: [
        ...
        },
        {
          icon: "🔧",
          title: "三分支规则",
          desc: "有专家支持就保留、两专家一致就替换、全不一致就精炼"
        },
        {
          icon: "✨",
          title: "图图比对",
