# Sapiens2：高分辨率人类视觉的细节与语义协同 交互式教程

基于论文 *Sapiens2*，由 **paper-skill** 生成的完整 React + TypeScript + Vite 网页项目。
...
- 论文：[*Sapiens 2*](https://arxiv.org/abs/2604.21681)，Rawal Khirodkar 等，ICLR 2026。
- `public/images/sapiens-evolution.png` 与 `public/images/hierarchical-attention.png`：为本教程生成的原创教学插图，用于解释两代模型的升级与 4K 分层注意力；未使用论文原图、人物照片或其他第三方图片。
- 其余动态效果由项目内的 Canvas 与 CSS 代码绘制和驱动。
